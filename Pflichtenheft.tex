...
\hyphenation{Be-dien-ober-flä-che} % ..-o-ber-.. sieht nicht  gut aus
\hyphenation{Be-o-bach-tungs-mo-dus}
\hyphenation{Op-tion}
\hyphenation{Me-nü-but-ton}
\hyphenation{Me-nü-but-tons}
...
\makeglossaries
\begin{document}
\include{./subtopicsFuncspec/Deckblatt}
% \maketitle
\tableofcontents
\newpage
%content
...
\include{./subtopicsFuncspec/Entwicklungsumgebung}
\include{./subtopicsFuncspec/Anhang}
%end content
