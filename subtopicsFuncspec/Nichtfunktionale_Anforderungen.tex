...
\item \textbf{Zusatzspeicher nach Auslösen} \hfill\\ Nach Auslösen des \glslink{G-Sensor}{G-Sensors}/Speicherbutton wird zusätzlich zum \gls{Ringpuffer} die folgenden XX Minuten Video \glslink{persistieren}{persistiert}.
...
\item \label{na:paralleleZugriffe}\textbf{Parallele Zugriffe} \hfill\\  Es sollen bis zu XX Videos parallel \glslink{anonymisieren}{anonymisiert} werden können.
